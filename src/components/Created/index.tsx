...
const Created: FC<IProps> = () => {
	const [isCopy, setIsCopy] = useState<boolean>(false)
	const url = 'http://localhost:3000/create?type=telegram&name=amirisaev&sended=true'
	...
	return (
		<div className='py-10 px-7'>
			<div>
				...
				<h3 className='mt-2'>
					Нам неважно, какие у Вас компетенции, мы смотрим в первую очередь на личные качества человека. Компетенции - это лишь набор инструментов для решения задач. Например, если Вы ветеринар, но
					обладаете сильными личными качествами, мы будем готовы взять Вас в команду. А чем Вы будете заниматься во благо команды - решить нетрудно.
				</h3>
			</div>
